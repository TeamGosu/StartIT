...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { bookingid: @training.bookingid, coursedescription: @training.coursedescription, coursename: @training.coursename, date: @training.date, id: @training.id, region: @training.region, time: @training.time }
    end
  ...
  test "should update training" do
    put :update, id: @training, training: { bookingid: @training.bookingid, coursedescription: @training.coursedescription, coursename: @training.coursename, date: @training.date, id: @training.id, region: @training.region, time: @training.time }
    assert_redirected_to training_path(assigns(:training))
  end
